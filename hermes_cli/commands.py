...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("dashboard", "Show all active agent locks and their ticket status", "Info"),
    ...
    CommandDef("trigger", "Manually trigger a Developer/Reviewer/QA agent for a Linear ticket without changing its status",
               "Session", gateway_only=True, args_hint="<role> <ticket-id> [prompt]"),
